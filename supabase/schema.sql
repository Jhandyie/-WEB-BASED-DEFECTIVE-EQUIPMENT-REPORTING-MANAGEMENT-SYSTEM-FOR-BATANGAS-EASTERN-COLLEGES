...
-- =========================================================
-- Technician budget / repair-expense requests (optional feature)
-- =========================================================
...
create index if not exists idx_budget_requests_report on public.budget_requests (report_id);
create index if not exists idx_budget_requests_technician on public.budget_requests (technician_id);
...
create table if not exists public.budget_request_items (
  ...
  request_id varchar(32) not null references public.budget_requests(request_id) on delete cascade,
  part_needed varchar(200) not null,
  quantity integer not null default 1,
