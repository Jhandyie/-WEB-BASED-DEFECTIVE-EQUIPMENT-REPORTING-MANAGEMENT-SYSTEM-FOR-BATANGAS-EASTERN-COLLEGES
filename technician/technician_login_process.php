...
function verifyLogin() {
    ...
    // (stops credential spraying — trying many different technician emails from one machine).
    try {
        RateLimiter::enforce('tech_login_ip:' . RateLimiter::clientIp(), 20, 900);
...
function resetPassword() {
    ...
    try { RateLimiter::enforce('tech_reset:' . RateLimiter::clientIp(), 10, 900); }
