...
if (!in_array($per, [10,20,50], true)) { $per = 10; }
...
function catIco($c){$m=['computer'=>'fa-desktop','laptop'=>'fa-laptop','projector'=>'fa-projector','printer'=>'fa-print','scanner'=>'fa-barcode','server'=>'fa-server','network'=>'fa-network-wired','phone'=>'fa-phone','camera'=>'fa-camera','audio'=>'fa-volume-up','furniture'=>'fa-chair','vehicle'=>'fa-car','aircon'=>'fa-snowflake','other'=>'fa-box'];foreach($m as $k=>$v)if(str_contains(strtolower($c??''),$k))return 'fas '.$v;return'fas fa-box';}
