    ...
    $message =
      ...
      . '<tr><td style="background-color:#f9f9f9;padding:44px 40px 40px;">'
          ...
          . '<tr><td align="center" style="padding:28px 20px 24px;">'
              ...
              . '</tr></table></td>'
              . '</tr></table>'
              . '<p style="margin:18px 0 0;font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#888888;font-weight:500;">&#9203;&nbsp; Valid for <strong style="color:#8b0000;">3 minutes</strong> only</p>'
          . '</td></tr></table>'
          ...
          . '<td style="padding:22px 22px 22px 16px;">'
              ...
              . '<td style="font-family:Arial,Helvetica,sans-serif;font-size:13px;color:#7a6010;line-height:1.55;">This OTP is valid for <strong>3 minutes</strong> only &mdash; do not delay</td>'
              . '</tr></table></td></tr>'
              . '<tr><td style="padding:6px 0;border-bottom:1px solid rgba(201,162,39,0.18);">'
              . '<table cellpadding="0" cellspacing="0" border="0"><tr>'
              . '<td style="padding-right:8px;font-size:16px;color:#c9a227;font-weight:700;vertical-align:top;">&#8250;</td>'
      ...
      . '</body></html>';
    // ── Clean, institutional BEC template (overrides the legacy layout above) ──
    $subject = 'BEC PMO — Your login verification code';
    $codeDisplay = htmlspecialchars(str_pad((string)$otp, 6, '0', STR_PAD_LEFT));
    $roleSafe = htmlspecialchars($roleName);
    $message =
      ...
      . '<table width="560" cellpadding="0" cellspacing="0" role="presentation" style="max-width:560px;width:100%;background:#ffffff;border:1px solid #e2d9cc;border-radius:14px;overflow:hidden;">'

      // accent + maroon header
      ...
      . '<tr><td style="background:#4A0E0E;padding:26px 32px;text-align:center;">'
        ...
        . '<div style="font-size:12px;color:rgba(255,255,255,.72);margin-top:4px;letter-spacing:.4px;">Property Management Office</div>'
      ...
      // body
      . '<tr><td style="padding:30px 32px 26px;color:#1C1008;">'
        . '<p style="margin:0 0 6px;font-size:16px;font-weight:700;color:#1C1008;">Hello, ' . $roleSafe . '</p>'
        . '<p style="margin:0 0 22px;font-size:14px;line-height:1.65;color:#5C3838;">'
          . 'A sign-in to the BEC Equipment Management System was requested for your account. '
          . 'Enter the one-time verification code below to continue.</p>'

        // code box
        . '<table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="background:#FBF9F6;border:1px solid #e2d9cc;border-radius:10px;">'
        . '<tr><td align="center" style="padding:22px 16px;">'
          . '<div style="font-size:11px;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#8A7466;margin-bottom:12px;">Verification Code</div>'
          . '<div style="font-family:\'Courier New\',Courier,monospace;font-size:34px;font-weight:700;letter-spacing:10px;color:#7B1D1D;padding-left:10px;">' . $codeDisplay . '</div>'
          . '<div style="font-size:12px;color:#8A7466;margin-top:12px;">&#9203; Expires in <strong style="color:#7B1D1D;">3 minutes</strong></div>'
        . '</td></tr></table>'

        // security note
        . '<p style="margin:20px 0 0;font-size:12.5px;line-height:1.6;color:#5C3838;background:#FFFBEF;border-left:3px solid #C9960C;border-radius:8px;padding:12px 14px;">'
          . '<strong>For your security:</strong> never share this code with anyone, including IT staff. '
          . 'If you did not request it, you can safely ignore this email.</p>'

        . '<p style="margin:20px 0 0;font-size:13px;color:#8A7466;">Need help signing in? Contact the Property Management Office.</p>'
      . '</td></tr>'
