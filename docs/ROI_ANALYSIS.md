...
Under base-case assumptions (1,200 defect reports per annum), the study estimates a Year-0 investment of **₱185,944**, recurring annual costs of **₱34,149**, and gross annual benefits of **₱165,880**. This yields a five-year **Net Present Value (NPV) of ₱313,420**, a **Benefit–Cost Ratio (BCR) of 1.99**, a **five-year ROI of 99.4%**, an **Internal Rate of Return (IRR) of approximately 65%**, and a **simple payback period of 16.9 months** (19.3 months discounted). The equivalent annual cost of operating the system is **₱83,201**, or **₱69.33 per defect report processed** and **₱16.64 per registered campus user per year**.

Sensitivity analysis establishes that the investment remains economically justified (NPV > 0) so long as realized benefits exceed **50.2%** of the base-case estimate, or costs do not exceed **200%** of the base-case estimate. The analysis is, however, materially sensitive to two inputs — the shadow price assigned to institutional labor time and the assumed reduction in corrective maintenance expenditure — and the study identifies both as priority targets for post-implementation empirical validation. A comparative make-versus-buy analysis further finds the in-house system's five-year TCO to be **55.8% lower** than the lowest-priced comparable commercial CMMS subscription.
...
**Payback horizon.** Most organizations achieve positive ROI **within 12–18 months** of CMMS implementation (LLumin, 2026; Oxmaint, 2026). The base-case payback period computed in §9 (16.9 months) falls within this documented range, which provides external plausibility support for the present estimates.
...
| T4 | Anthropic Claude API — model `claude-haiku-4-5` | US$1.00/M input tokens; US$5.00/M output tokens | Anthropic published pricing, 2026 |
| T5 | Estimated AI assistant usage | 12,000 requests/yr @ ~2,500 input + 250 output tokens | 3,000 conversations × 4 turns; engineering estimate |
| T6 | USD–PHP exchange rate | ₱61.02 = US$1.00 | August 2026 monthly average (exchange-rates.org, 2026) |

**Note on T4.** The system's three "Becca" assistant instances (`chat_proxy.php`, `admin_chat_proxy.php`, `technician_chat_proxy.php`) all invoke the `claude-haiku-4-5` model. At the stated volumes the annual token consumption is approximately 30M input and 3M output tokens, yielding US$30 + US$15 = **US$45/yr ≈ ₱2,746**.
...
| R4 | Anthropic Claude API (AI assistant) | US$45 × ₱61.02 | ₱2,746 |
...
| | **TOTAL RECURRING ANNUAL COST** | | **₱34,149** |
...
$$PV(C) = 185{,}944 + (34{,}149 \times 3.790787) = 185{,}944 + 129{,}452 = \boxed{₱315{,}396}$$
...
| 1 | ₱165,880 | ₱34,149 | ₱131,731 | 0.9091 | ₱119,755 | (₱66,189) |
| 2 | ₱165,880 | ₱34,149 | ₱131,731 | 0.8264 | ₱108,869 | ₱42,680 |
| 3 | ₱165,880 | ₱34,149 | ₱131,731 | 0.7513 | ₱98,972 | ₱141,652 |
| 4 | ₱165,880 | ₱34,149 | ₱131,731 | 0.6830 | ₱89,974 | ₱231,626 |
| 5 | ₱165,880 | ₱34,149 | ₱131,731 | 0.6209 | ₱81,794 | **₱313,420** |
| **Total** | **₱829,400** | **₱356,689** | **₱472,711** | | | |

### 9.2 Computation of Indicators

**Net Present Value**

$$NPV = PV(B) - PV(C) = 628{,}816 - 315{,}396 = \boxed{₱313{,}420}$$

**Benefit–Cost Ratio**

$$BCR = \frac{628{,}816}{315{,}396} = \boxed{1.99}$$

**Return on Investment (five-year, discounted)**

$$ROI = \frac{313{,}420}{315{,}396} \times 100\% = \boxed{99.4\%}$$

**Internal Rate of Return.** Solving *A*<sub>5,r\*</sub> = 185,944 ÷ 131,731 = 1.4116 yields:

$$IRR \approx \boxed{65\%}$$

**Payback Period.** Undiscounted:

$$PP = \frac{185{,}944}{131{,}731} = 1.41 \text{ years} = \boxed{16.9 \text{ months}}$$

Discounted (from Table 9.1, cumulative PV crosses zero during Year 2):

$$PP_{disc} = 1 + \frac{66{,}189}{108{,}869} = 1.61 \text{ years} = \boxed{19.3 \text{ months}}$$

**Equivalent Annual Cost**

$$EAC = \frac{315{,}396}{3.790787} = \boxed{₱83{,}201/\text{year}}$$
...
|---|---:|---|---|
| Net Present Value (5 yr, 10%) | **₱313,420** | NPV > 0 | **PASS** |
| Benefit–Cost Ratio | **1.99** | BCR > 1.0 | **PASS** |
| Return on Investment (5 yr) | **99.4%** | ROI > 0% | **PASS** |
| Internal Rate of Return | **≈65%** | IRR > 10% | **PASS** |
| Payback period (simple) | **16.9 months** | < 5 yr horizon | **PASS** |
| Payback period (discounted) | **19.3 months** | < 5 yr horizon | **PASS** |
...
|---|---|---:|
| Equivalent annual cost of ownership | PV(C) ÷ 3.790787 | ₱83,201/yr |
| Cost per defect report processed | ₱83,201 ÷ 1,200 | **₱69.33** |
| Cost per registered campus user per year | ₱83,201 ÷ 5,000 | **₱16.64** |
| Net benefit per defect report processed | (₱165,880 − ₱34,149) ÷ 1,200 | **₱109.78** |
...
Three scenarios are constructed by varying the four principal benefit drivers. Cost parameters are held constant across scenarios (except for a modest hosting and API allowance in the optimistic case reflecting higher transaction volume), since costs are determined by the build rather than by usage; cost uncertainty is treated separately in §11.
...
| Recurring annual cost | ₱34,149 | ₱34,149 | ₱37,449 |
...
| PV of costs | ₱315,396 | ₱315,396 | ₱327,904 |
| **NPV** | **(₱10,037)** | **₱313,420** | **₱890,758** |
| **BCR** | **0.97** | **1.99** | **3.72** |
| **ROI (5 yr)** | **−3.2%** | **99.4%** | **271.7%** |
| **IRR** | **≈7.9%** | **≈65%** | **≈151%** |
| **Payback (simple)** | **48.1 months** | **16.9 months** | **7.9 months** |
| **Verdict** | Marginally not justified | **Justified** | Strongly justified |

### 10.1 Interpretation

The pessimistic scenario — which simultaneously assumes a one-third lower report volume, 40% smaller per-transaction time savings, and a maintenance-expenditure reduction of only 2.5% — produces an NPV of −₱10,037 and an IRR of 7.9%. This is **marginally below the 10% hurdle rate but very close to break-even**: the project would still recover its full shadow-priced investment within 48 months, and would be comfortably positive at a discount rate of 7% or lower.

The practical significance of this finding is that the investment is **not fragile**. Even under a conjunction of adverse assumptions that would be unusual in practice, the loss is bounded at approximately ₱10,000 in present-value terms — roughly 3% of the resources committed. The asymmetry of the outcome distribution (−₱10,037 to +₱890,758) is strongly favorable.
...
|---|---|---|---:|---:|---|
| S0 | *(Base case)* | — | ₱313,420 | 1.99 | Justified |
| S1 | Discount rate | 6% (lower) | ₱368,956 | 2.12 | Justified |
| S2 | Discount rate | 15% (higher) | ₱255,639 | 1.85 | Justified |
| S3 | All benefits | −25% | ₱156,216 | 1.50 | Justified |
| S4 | All benefits | −40% | ₱61,894 | 1.20 | Justified |
| S5 | All benefits | −50% | (₱988) | 1.00 | **Break-even** |
| S6 | All costs | +50% | ₱155,722 | 1.33 | Justified |
| S7 | All costs | +100% | (₱1,976) | 1.00 | **Break-even** |
| S8 | Report volume | 800/yr (−33%) | ₱191,838 | 1.61 | Justified |
| S9 | **All labor-time benefits excluded** (B1+B2+B3 = ₱0) | Removes ₱93,880/yr | **(₱42,459)** | **0.87** | **Not justified** |
| S10 | **Maintenance-expenditure benefit excluded** (B6 = ₱0) | Removes ₱60,000/yr | **₱85,972** | **1.27** | Justified |
...
Conversely, test S10 shows that removing the largest and least-validated single line (B6, maintenance expenditure reduction) still leaves the project justified at BCR 1.27. The analysis is therefore **not** dependent on the maintenance-reduction assumption, which is the more reassuring of the two findings.
...
|---|---:|---:|---:|
| Minimum annual gross benefit for NPV = 0 | ₱83,201 | ₱165,880 | **49.8%** |
| Maximum PV of total cost for NPV = 0 | ₱628,816 | ₱315,396 | **99.4%** |
| Minimum annual report volume (with B6 retained) | 169 reports | 1,200 | **85.9%** |
| Minimum annual report volume (with B6 excluded) | 917 reports | 1,200 | **23.6%** |
| Maximum discount rate for NPV = 0 (IRR) | ≈65% | 10% | **55 pp** |

The break-even annual benefit of ₱83,201 is, by construction, identical to the equivalent annual cost computed in §9.4. The investment is justified provided the system delivers annual benefits of at least **₱83,201 — equivalently, ₱69.33 per report at base volume.**
...
|---|---:|---:|---:|---:|
| **In-house system (this study)** | ₱185,944 | ₱34,149 | ₱129,452 | **₱315,396** |
...
The in-house system's five-year total cost of ownership is **₱397,702 (55.8%) lower** than the lowest-priced comparable commercial subscription, and **₱1,441,594 (82.0%) lower** than a mid-tier commercial platform. On a cash basis — excluding the imputed development cost — the differential widens to **₱583,646 (81.9%)** against the entry tier.

Two qualifications apply. Commercial platforms deliver vendor-provided support, guaranteed uptime, and a maintenance roadmap, none of which the in-house system carries; these are real values not captured in the cost comparison. Conversely, the in-house system is precisely fitted to BEC's workflow, official forms, and institutional identity, and the institution retains full ownership of both code and data — advantages a commercial subscription does not confer. **The cost differential is nonetheless of a magnitude (a factor of 2.3 to 5.6) that is unlikely to be reversed by these considerations.**
...
| K6 | **Benefit estimates prove optimistic** | Medium | Bounded — see §10 pessimistic scenario (NPV −₱10,037) | Conduct the post-implementation measurement programme in §17 |
...
2. **Unvalidated volume parameter.** Annual report volume (A2 = 1,200) is estimated rather than observed. Section 11.3 establishes a break-even volume of 917 reports per annum with the maintenance-reduction benefit excluded; the estimate is therefore not extravagantly above the threshold, and validation is material.
...
**16.1** The BEC Web-Based Defective Equipment Reporting Management System is **economically justified** under base-case assumptions. It returns a five-year Net Present Value of **₱313,420** at the NEDA-prescribed 10% social discount rate, a Benefit–Cost Ratio of **1.99**, a five-year Return on Investment of **99.4%**, and an Internal Rate of Return of approximately **65%** — the latter exceeding the hurdle rate by 55 percentage points.

**16.2** The investment **recovers its full shadow-priced cost within 16.9 months** (19.3 months on a discounted basis). This falls within the 12–18 month payback range documented in the CMMS implementation literature, providing external plausibility support for the estimate.

**16.3** The system costs the institution an equivalent **₱83,201 per annum**, or **₱69.33 per defect report processed** and **₱16.64 per registered campus user per year**.

**16.4** The conclusion is **robust to substantial parameter error**. It survives a 50% overstatement of benefits, a 100% understatement of costs, a one-third reduction in report volume, discount rates from 6% to 15%, and the complete removal of the largest single benefit line.

**16.5** The conclusion is, however, **conditional on accepting the monetization of institutional labor time**. Excluding all labor-time benefits reverses the finding (NPV −₱42,459, BCR 0.87). This dependency is the study's principal analytical caveat.

**16.6** Under the pessimistic scenario the project is **marginally not justified** (NPV −₱10,037, IRR 7.9%) — but the downside is bounded at approximately 3% of committed resources, against an optimistic-case upside of ₱890,758. The **risk–return profile is strongly asymmetric in the institution's favor.**

**16.7** Against the commercial alternative, the in-house system's five-year total cost of ownership is **55.8% lower** than the least expensive comparable CMMS subscription and **82.0% lower** than a mid-tier platform. The **make decision is supported on cost grounds by a wide margin.**
...
Anthropic. (2026). *Claude API pricing* [Model pricing schedule: `claude-haiku-4-5`, US$1.00/MTok input, US$5.00/MTok output]. https://platform.claude.com/docs/en/pricing
